...
Canonical Lane research workspace for a flagship problem in anabelian geometry and arithmetic geometry:
proving existence and identification of rational sections of the étale fundamental exact sequence through an admissible section-packet closure architecture.

## Main Manuscript

- [paper/SECTION_CONJECTURE_PREPRINT.md](paper/SECTION_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `SECTION_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/SECTION_CONJECTURE_PREPRINT.md`.
...
Current SC runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/sc_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/sc_closure_guard.py`.
...
- Manuscript target: [paper/SECTION_CONJECTURE_PREPRINT.md](paper/SECTION_CONJECTURE_PREPRINT.md)
