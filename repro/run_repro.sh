...
mkdir -p .repro_tmp/section_conjecture
cp artifacts/stitch_constants.json .repro_tmp/section_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/section_conjecture/constants_registry.json
