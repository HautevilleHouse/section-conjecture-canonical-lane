...
mkdir -p .tmp/section_conjecture
cp artifacts/stitch_constants.json .tmp/section_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/section_conjecture/constants_registry.json
