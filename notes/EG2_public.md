...
`sigma_fundamental^(raw) := fundamental_floor_raw - section_loss_raw - restart_loss_raw`.
...
Main interpretation: the tracked fundamental-group defect does not consume the full closure budget.
